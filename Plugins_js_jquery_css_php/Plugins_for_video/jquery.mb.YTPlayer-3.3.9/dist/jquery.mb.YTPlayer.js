...
(function (jQuery, ytp) {
  jQuery.mbYTPlayer = {
    ...
    buildPlayer: function (options) {
      ...
      return this.each(function () {
        ...
        origContainmentBackground =
          origContainmentBackground === "none"
            ? null
            : origContainmentBackground;
        ...
        if (YTPlayer.isPlayer) {
          let inlinePlayButtonCss = jQuery.mbBrowser.mobile
        ...
        $YTPlayer.one("YTAPIReady_" + YTPlayer.id, function () {
          ...
          jQuery(YTPlayer).on("YTPChanged", function (e) {
            ...
            let playerVars = {
              ...
              playsinline:
                jQuery.mbBrowser.mobile && !YTPlayer.isPlayer ? 1 : 0,
    ...
    fullscreen: function (real) {
      ...
      let videoWrapper = YTPlayer.isPlayer
        ? YTPlayer.opt.containment
        : YTPlayer.wrapper;

      if (real) {
        let fullscreenchange = jQuery.mbBrowser.mozilla
          ? "mozfullscreenchange"
    ...
    buildControls: function (YTPlayer) {
      ...
      let loadedBar = jQuery("<div/>")
        .addClass("mb_YTPLoaded")
        .css("position", "absolute");
      let timeBar = jQuery("<div/>")
    ...
    checkForState: function () {
      ...
      YTPlayer.getState = setInterval(function () {
        ...
        if (YTPlayer.opt.playOnlyIfVisible) {
          let isOnScreen = jQuery.mbYTPlayer.isOnScreen(
            YTPlayer,
            YTPlayer.opt.onScreenPercentage,
          );
        ...
        if (
          ...
          (parseFloat(
            YTPlayer.player.getDuration() - YTPlayer.opt.fadeOnStartTime / 1000,
        ...
        if (
          ...
          if (!YTPlayer.opt.mute) {
            if (YTPlayer.opt.autoPlay) {
              console.debug(
                "We muted the audio to make the video 'auto-play' according with the latest vendor policy. " +
...
var getOS = function () {
  ...
  /Mac OS X/.test(nAgt) &&
    !/Mobile/.test(nAgt) &&
    ((a.version = /Mac OS X ([\._\d]+)/.exec(nAgt)[1]),
...
function setFilter(d, a, b) {
  ...
  b = setUnit(
    b > jQuery.CSS.filters[a].max ? jQuery.CSS.filters[a].max : b,
    jQuery.CSS.filters[a].unit,
  );
  d[g + "filter"] += c + "(" + b + ") ";
  delete d[a];
}
jQuery.CSS = {
  ...
  normalizeCss: function (d) {
    ...
    jQuery.mbBrowser.webkit || jQuery.mbBrowser.opera
  ...
  animate: function (d, a, b, c, g) {
    return this.each(function () {
      ...
      if (
        ...
        ((e.CSSqueue = null), (e.eventType = k.type), 0 !== h.length && d)
      ) {
        ...
        "function" == typeof c &&
          ((g = c), (c = "cubic-bezier(0.65,0.03,0.36,0.72)"));
        if ("string" == typeof a)
  ...
  b.simpleSlider = {
    ...
    init: function (d) {
      return this.each(function () {
        ...
        c.updateSliderVal();
        a.opt.readonly ||
          (c.on(b.simpleSlider.events.start, function (e) {
          ...
          b(document)
            .on(b.simpleSlider.events.move, function (e) {
              b.mbBrowser.mobile && (e = e.changedTouches[0]);
              a.canSlide &&
    ...
    updateSliderVal: function (d) {
      ...
      if (a.opt) {
        ...
        a.x =
          "object" == typeof d
            ? d.clientX + document.body.scrollLeft - this.offset().left
            : "number" == typeof d
              ? (d * c) / a.opt.maxval
              : (a.opt.initialval * c) / a.opt.maxval;
        a.y =
          "object" == typeof d
            ? d.clientY + document.body.scrollTop - this.offset().top
            : "number" == typeof d
              ? ((a.opt.maxval - a.opt.initialval - d) * f) / a.opt.maxval
        ...
        a.outOfRangeY =
          a.scaleY > a.opt.maxval
            ...
            : 0 > a.scaleY
              ...
              : 0;
        a.outOfRange =
          "h" === a.opt.orientation ? a.outOfRangeX : a.outOfRangeY;
        a.value =
          "undefined" != typeof d
            ? "h" === a.opt.orientation
              ? a.x >= this.outerWidth()
            ...
            : "h" === a.opt.orientation
              ...
              : a.scaleY;
        "h" === a.opt.orientation
          ? a.level.width(Math.floor((100 * a.x) / c) + "%")
          : a.level.height(Math.floor((100 * a.y) / f));
        (a.lastVal === a.value &&
          (("h" === a.opt.orientation &&
            (a.x >= this.outerWidth() || 0 >= a.x)) ||
            ("h" !== a.opt.orientation &&
              (a.y >= this.outerHeight() || 0 >= a.y)))) ||
